        ...
        <Card className="group cursor-pointer h-[300px] overflow-hidden transition-all hover:scale-105">
            <CardContent className="p-0 flex flex-col flex-1">
                <div className="relative aspect-video">
                    ...
                    {loading ? (
                        <>
                            <Skeleton className="absolute bottom-2 right-2 rounded w-[50px] h-[20px] bg-black/80 px-2 py-1 text-xs text-white" />
                        </>
                    ) : (
                ...
                <div className="p-4 flex flex-col flex-1 justify-between">
                    <h3 className="line-clamp-3 font-semibold min-h-[4.5rem]">
                        {title}
                    </h3>
